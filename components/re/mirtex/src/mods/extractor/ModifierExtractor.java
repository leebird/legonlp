...
import mods.extractor.pattern.ModifierPatternReader;
import edu.stanford.nlp.trees.Tree;
import edu.stanford.nlp.trees.Treebank;
import edu.stanford.nlp.trees.tregex.TregexMatcher;
import edu.stanford.nlp.trees.tregex.TregexPattern;

public class ModifierExtractor extends FileProcessor {
  ...
  public ModifierExtractor() {
    isSimplify = true;
    patterns = ModifierPatternReader.getPatterns(
        Env.MODIFIER_TREGEX,
