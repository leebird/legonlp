 ...
 */
	...
	public void log()
	{
		System.err.println("Lemmatiser: " + (lemmatiser == null ? null : lemmatiser.getClass().getName()));
		System.err.println("POSTagger: " + (posTagger == null ? null : posTagger.getClass().getName()));
		System.err.println("Tokenizer: " + tokenizer.getClass().getName());
		System.err.println("Tag format: " + tagFormat.name());
		System.err.println("PostProcessor: " + (postProcessor == null ? null : postProcessor.getClass().getName()));
		System.err.println("Using numeric normalization: " + useNumericNormalization);
		System.err.println("CRF order is " + order);
		System.err.println("Using feature induction: " + useFeatureInduction);
		System.err.println("Text textDirection: " + textDirection);
	}
