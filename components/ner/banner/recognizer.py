...
class Banner:
    ...
    def remove_extra_space(self,text):
        ...
        text = re.sub(p1,ur'\1',text,flags=re.U)
        text = re.sub(p2,ur'\1',text,flags=re.U)
        text = re.sub(p2,ur'\1'+u' ',text,flags=re.U)
        text = re.sub(p3,ur'\1',text,flags=re.U)
        text = re.sub(p5,ur'\1 \2',text,flags=re.U)
        text = re.sub(p6,ur'\1.\3',text,flags=re.U)
